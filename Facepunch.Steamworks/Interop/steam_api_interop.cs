...
namespace Valve.Interop
{
    internal class NativeEntrypoints
    {
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamUser_TerminateGameConnection" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamUser_GetAvailableVoice" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamUser_GetVoice" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamUser_DecompressVoice" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamUser_GetVoiceOptimalSampleRate" )]
        internal static extern uint SteamAPI_ISteamUser_GetVoiceOptimalSampleRate( IntPtr instancePtr );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamUser_GetAuthSessionTicket" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamUser_BeginAuthSession" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamUser_EndAuthSession" )]
        internal static extern void SteamAPI_ISteamUser_EndAuthSession( IntPtr instancePtr, ulong steamID );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamUser_CancelAuthTicket" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamFriends_GetPersonaState" )]
        internal static extern uint SteamAPI_ISteamFriends_GetPersonaState( IntPtr instancePtr );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamFriends_GetFriendCount" )]
        internal static extern int SteamAPI_ISteamFriends_GetFriendCount( IntPtr instancePtr, int iFriendFlags );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamFriends_GetFriendByIndex" )]
        internal static extern ulong SteamAPI_ISteamFriends_GetFriendByIndex( IntPtr instancePtr, int iFriend, int iFriendFlags );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamFriends_GetFriendRelationship" )]
        internal static extern uint SteamAPI_ISteamFriends_GetFriendRelationship( IntPtr instancePtr, ulong steamIDFriend );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamFriends_GetFriendPersonaState" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamFriends_GetPlayerNickname" )]
        internal static extern IntPtr SteamAPI_ISteamFriends_GetPlayerNickname( IntPtr instancePtr, ulong steamIDPlayer );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamFriends_GetFriendsGroupCount" )]
        internal static extern int SteamAPI_ISteamFriends_GetFriendsGroupCount( IntPtr instancePtr );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamFriends_GetFriendsGroupIDByIndex" )]
        internal static extern char SteamAPI_ISteamFriends_GetFriendsGroupIDByIndex( IntPtr instancePtr, int iFG );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamFriends_GetFriendsGroupName" )]
        internal static extern IntPtr SteamAPI_ISteamFriends_GetFriendsGroupName( IntPtr instancePtr, char friendsGroupID );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamFriends_GetFriendsGroupMembersCount" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamFriends_GetClanName" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamFriends_ActivateGameOverlayToUser" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamFriends_ActivateGameOverlayToWebPage" )]
        internal static extern void SteamAPI_ISteamFriends_ActivateGameOverlayToWebPage( IntPtr instancePtr, string pchURL );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamFriends_ActivateGameOverlayToStore" )]
        internal static extern void SteamAPI_ISteamFriends_ActivateGameOverlayToStore( IntPtr instancePtr, uint nAppID, char eFlag );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamFriends_SetPlayedWith" )]
        internal static extern void SteamAPI_ISteamFriends_SetPlayedWith( IntPtr instancePtr, ulong steamIDUserPlayedWith );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamFriends_ActivateGameOverlayInviteDialog" )]
        internal static extern void SteamAPI_ISteamFriends_ActivateGameOverlayInviteDialog( IntPtr instancePtr, ulong steamIDLobby );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamFriends_GetSmallFriendAvatar" )]
        internal static extern int SteamAPI_ISteamFriends_GetSmallFriendAvatar( IntPtr instancePtr, ulong steamIDFriend );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamFriends_GetMediumFriendAvatar" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamFriends_GetClanOfficerCount" )]
        internal static extern int SteamAPI_ISteamFriends_GetClanOfficerCount( IntPtr instancePtr, ulong steamIDClan );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamFriends_GetClanOfficerByIndex" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamFriends_GetFriendRichPresenceKeyCount" )]
        internal static extern int SteamAPI_ISteamFriends_GetFriendRichPresenceKeyCount( IntPtr instancePtr, ulong steamIDFriend );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamFriends_GetFriendRichPresenceKeyByIndex" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamFriends_GetFriendCoplayTime" )]
        internal static extern int SteamAPI_ISteamFriends_GetFriendCoplayTime( IntPtr instancePtr, ulong steamIDFriend );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamFriends_GetFriendCoplayGame" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamFriends_IsFollowing" )]
        internal static extern ulong SteamAPI_ISteamFriends_IsFollowing( IntPtr instancePtr, ulong steamID );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamFriends_EnumerateFollowingList" )]
        internal static extern ulong SteamAPI_ISteamFriends_EnumerateFollowingList( IntPtr instancePtr, uint unStartIndex );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamUtils_GetSecondsSinceAppActive" )]
        internal static extern uint SteamAPI_ISteamUtils_GetSecondsSinceAppActive( IntPtr instancePtr );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamUtils_GetSecondsSinceComputerActive" )]
        internal static extern uint SteamAPI_ISteamUtils_GetSecondsSinceComputerActive( IntPtr instancePtr );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamUtils_GetConnectedUniverse" )]
        internal static extern int SteamAPI_ISteamUtils_GetConnectedUniverse( IntPtr instancePtr );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamUtils_GetServerRealTime" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamMatchmaking_AddRequestLobbyListNumericalFilter" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamMatchmaking_AddRequestLobbyListNearValueFilter" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamMatchmaking_AddRequestLobbyListFilterSlotsAvailable" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamMatchmaking_AddRequestLobbyListDistanceFilter" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamMatchmaking_AddRequestLobbyListResultCountFilter" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamMatchmaking_AddRequestLobbyListCompatibleMembersFilter" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamMatchmaking_GetLobbyByIndex" )]
        internal static extern ulong SteamAPI_ISteamMatchmaking_GetLobbyByIndex( IntPtr instancePtr, int iLobby );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamMatchmaking_CreateLobby" )]
        internal static extern ulong SteamAPI_ISteamMatchmaking_CreateLobby( IntPtr instancePtr, uint eLobbyType, int cMaxMembers );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamMatchmaking_JoinLobby" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamMatchmakingServerListResponse_RefreshComplete" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamMatchmakingPingResponse_ServerResponded" )]
        internal static extern void SteamAPI_ISteamMatchmakingPingResponse_ServerResponded( IntPtr instancePtr, IntPtr server );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamMatchmakingPingResponse_ServerFailedToRespond" )]
        internal static extern void SteamAPI_ISteamMatchmakingPingResponse_ServerFailedToRespond( IntPtr instancePtr );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamMatchmakingPlayersResponse_AddPlayerToList" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamMatchmakingPlayersResponse_PlayersFailedToRespond" )]
        internal static extern void SteamAPI_ISteamMatchmakingPlayersResponse_PlayersFailedToRespond( IntPtr instancePtr );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamMatchmakingPlayersResponse_PlayersRefreshComplete" )]
        internal static extern void SteamAPI_ISteamMatchmakingPlayersResponse_PlayersRefreshComplete( IntPtr instancePtr );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamMatchmakingRulesResponse_RulesResponded" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamMatchmakingRulesResponse_RulesFailedToRespond" )]
        internal static extern void SteamAPI_ISteamMatchmakingRulesResponse_RulesFailedToRespond( IntPtr instancePtr );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamMatchmakingRulesResponse_RulesRefreshComplete" )]
        internal static extern void SteamAPI_ISteamMatchmakingRulesResponse_RulesRefreshComplete( IntPtr instancePtr );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamMatchmakingServers_RequestInternetServerList" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamMatchmakingServers_RequestLANServerList" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamMatchmakingServers_RequestFriendsServerList" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamMatchmakingServers_RequestFavoritesServerList" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamMatchmakingServers_RequestHistoryServerList" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamMatchmakingServers_RequestSpectatorServerList" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamMatchmakingServers_ReleaseRequest" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamMatchmakingServers_GetServerDetails" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamMatchmakingServers_CancelQuery" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamMatchmakingServers_PingServer" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamMatchmakingServers_PlayerDetails" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamMatchmakingServers_ServerRules" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamRemoteStorage_GetSyncPlatforms" )]
        internal static extern uint SteamAPI_ISteamRemoteStorage_GetSyncPlatforms( IntPtr instancePtr, string pchFile );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamRemoteStorage_GetFileCount" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamRemoteStorage_GetCachedUGCHandle" )]
        internal static extern ulong SteamAPI_ISteamRemoteStorage_GetCachedUGCHandle( IntPtr instancePtr, int iCachedContent );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamRemoteStorage_PublishWorkshopFile" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamRemoteStorage_DeletePublishedFile" )]
        internal static extern ulong SteamAPI_ISteamRemoteStorage_DeletePublishedFile( IntPtr instancePtr, ulong unPublishedFileId );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamRemoteStorage_EnumerateUserPublishedFiles" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamRemoteStorage_SubscribePublishedFile" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamRemoteStorage_EnumerateUserSubscribedFiles" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamRemoteStorage_GetUserPublishedItemVoteDetails" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamRemoteStorage_EnumerateUserSharedWorkshopFiles" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamRemoteStorage_PublishVideo" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamRemoteStorage_SetUserPublishedFileAction" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamRemoteStorage_EnumeratePublishedFilesByUserAction" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamRemoteStorage_EnumeratePublishedWorkshopFiles" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamUserStats_GetLeaderboardName" )]
        internal static extern IntPtr SteamAPI_ISteamUserStats_GetLeaderboardName( IntPtr instancePtr, ulong hSteamLeaderboard );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamUserStats_GetLeaderboardEntryCount" )]
        internal static extern int SteamAPI_ISteamUserStats_GetLeaderboardEntryCount( IntPtr instancePtr, ulong hSteamLeaderboard );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamUserStats_GetLeaderboardSortMethod" )]
        internal static extern uint SteamAPI_ISteamUserStats_GetLeaderboardSortMethod( IntPtr instancePtr, ulong hSteamLeaderboard );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamUserStats_GetLeaderboardDisplayType" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamUserStats_DownloadLeaderboardEntries" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamUserStats_GetNumberOfCurrentPlayers" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamScreenshots_WriteScreenshot" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamScreenshots_AddScreenshotToLibrary" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamScreenshots_TriggerScreenshot" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamMusic_Pause" )]
        internal static extern void SteamAPI_ISteamMusic_Pause( IntPtr instancePtr );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamMusic_PlayPrevious" )]
        internal static extern void SteamAPI_ISteamMusic_PlayPrevious( IntPtr instancePtr );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamMusic_PlayNext" )]
        internal static extern void SteamAPI_ISteamMusic_PlayNext( IntPtr instancePtr );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamMusic_SetVolume" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamController_GetCurrentActionSet" )]
        internal static extern ulong SteamAPI_ISteamController_GetCurrentActionSet( IntPtr instancePtr, ulong controllerHandle );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamController_GetDigitalActionHandle" )]
        internal static extern ulong SteamAPI_ISteamController_GetDigitalActionHandle( IntPtr instancePtr, string pszActionName );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamController_GetDigitalActionData" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamController_GetDigitalActionOrigins" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamController_GetAnalogActionHandle" )]
        internal static extern ulong SteamAPI_ISteamController_GetAnalogActionHandle( IntPtr instancePtr, string pszActionName );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamController_GetAnalogActionData" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamController_GetAnalogActionOrigins" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamController_StopAnalogActionMomentum" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamController_TriggerHapticPulse" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamController_TriggerRepeatedHapticPulse" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamUGC_CreateQueryUserUGCRequest" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamUGC_SetUserItemVote" )]
        internal static extern ulong SteamAPI_ISteamUGC_SetUserItemVote( IntPtr instancePtr, ulong nPublishedFileID, bool bVoteUp );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamUGC_GetUserItemVote" )]
        internal static extern ulong SteamAPI_ISteamUGC_GetUserItemVote( IntPtr instancePtr, ulong nPublishedFileID );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamUGC_AddItemToFavorites" )]
        internal static extern ulong SteamAPI_ISteamUGC_AddItemToFavorites( IntPtr instancePtr, uint nAppId, ulong nPublishedFileID );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamUGC_RemoveItemFromFavorites" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamUGC_SubscribeItem" )]
        internal static extern ulong SteamAPI_ISteamUGC_SubscribeItem( IntPtr instancePtr, ulong nPublishedFileID );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamUGC_UnsubscribeItem" )]
        internal static extern ulong SteamAPI_ISteamUGC_UnsubscribeItem( IntPtr instancePtr, ulong nPublishedFileID );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamUGC_GetNumSubscribedItems" )]
        internal static extern uint SteamAPI_ISteamUGC_GetNumSubscribedItems( IntPtr instancePtr );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamUGC_GetSubscribedItems" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamAppList_GetInstalledApps" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamAppList_GetAppName" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamAppList_GetAppInstallDir" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamAppList_GetAppBuildId" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamHTMLSurface_LoadURL" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamHTMLSurface_SetSize" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamHTMLSurface_StopLoad" )]
        internal static extern void SteamAPI_ISteamHTMLSurface_StopLoad( IntPtr instancePtr, uint unBrowserHandle );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamHTMLSurface_Reload" )]
        internal static extern void SteamAPI_ISteamHTMLSurface_Reload( IntPtr instancePtr, uint unBrowserHandle );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamHTMLSurface_GoBack" )]
        internal static extern void SteamAPI_ISteamHTMLSurface_GoBack( IntPtr instancePtr, uint unBrowserHandle );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamHTMLSurface_GoForward" )]
        internal static extern void SteamAPI_ISteamHTMLSurface_GoForward( IntPtr instancePtr, uint unBrowserHandle );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamHTMLSurface_AddHeader" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamHTMLSurface_ExecuteJavascript" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamHTMLSurface_MouseUp" )]
        internal static extern void SteamAPI_ISteamHTMLSurface_MouseUp( IntPtr instancePtr, uint unBrowserHandle, uint eMouseButton );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamHTMLSurface_MouseDown" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamHTMLSurface_MouseDoubleClick" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamHTMLSurface_MouseMove" )]
        internal static extern void SteamAPI_ISteamHTMLSurface_MouseMove( IntPtr instancePtr, uint unBrowserHandle, int x, int y );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamHTMLSurface_MouseWheel" )]
        internal static extern void SteamAPI_ISteamHTMLSurface_MouseWheel( IntPtr instancePtr, uint unBrowserHandle, int nDelta );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamHTMLSurface_KeyDown" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamHTMLSurface_KeyUp" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamHTMLSurface_KeyChar" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamHTMLSurface_SetHorizontalScroll" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamHTMLSurface_SetVerticalScroll" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamHTMLSurface_SetKeyFocus" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamHTMLSurface_ViewSource" )]
        internal static extern void SteamAPI_ISteamHTMLSurface_ViewSource( IntPtr instancePtr, uint unBrowserHandle );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamHTMLSurface_CopyToClipboard" )]
        internal static extern void SteamAPI_ISteamHTMLSurface_CopyToClipboard( IntPtr instancePtr, uint unBrowserHandle );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamHTMLSurface_PasteFromClipboard" )]
        internal static extern void SteamAPI_ISteamHTMLSurface_PasteFromClipboard( IntPtr instancePtr, uint unBrowserHandle );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamHTMLSurface_Find" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamHTMLSurface_StopFind" )]
        internal static extern void SteamAPI_ISteamHTMLSurface_StopFind( IntPtr instancePtr, uint unBrowserHandle );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamHTMLSurface_GetLinkAtPosition" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamHTMLSurface_SetCookie" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamHTMLSurface_SetPageScaleFactor" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamHTMLSurface_SetBackgroundMode" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamHTMLSurface_AllowStartRequest" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamGameServer_SetModDir" )]
        internal static extern void SteamAPI_ISteamGameServer_SetModDir( IntPtr instancePtr, string pszModDir );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamGameServer_SetDedicatedServer" )]
        internal static extern void SteamAPI_ISteamGameServer_SetDedicatedServer( IntPtr instancePtr, bool bDedicated );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamGameServer_LogOn" )]
        internal static extern void SteamAPI_ISteamGameServer_LogOn( IntPtr instancePtr, string pszToken );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamGameServer_LogOnAnonymous" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamGameServer_SetServerName" )]
        internal static extern void SteamAPI_ISteamGameServer_SetServerName( IntPtr instancePtr, string pszServerName );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamGameServer_SetMapName" )]
        internal static extern void SteamAPI_ISteamGameServer_SetMapName( IntPtr instancePtr, string pszMapName );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamGameServer_SetPasswordProtected" )]
        internal static extern void SteamAPI_ISteamGameServer_SetPasswordProtected( IntPtr instancePtr, bool bPasswordProtected );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamGameServer_SetSpectatorPort" )]
        internal static extern void SteamAPI_ISteamGameServer_SetSpectatorPort( IntPtr instancePtr, char unSpectatorPort );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamGameServer_SetSpectatorServerName" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamGameServer_ClearAllKeyValues" )]
        internal static extern void SteamAPI_ISteamGameServer_ClearAllKeyValues( IntPtr instancePtr );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamGameServer_SetKeyValue" )]
        internal static extern void SteamAPI_ISteamGameServer_SetKeyValue( IntPtr instancePtr, string pKey, string pValue );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamGameServer_SetGameTags" )]
        internal static extern void SteamAPI_ISteamGameServer_SetGameTags( IntPtr instancePtr, string pchGameTags );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamGameServer_SetGameData" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamGameServer_EndAuthSession" )]
        internal static extern void SteamAPI_ISteamGameServer_EndAuthSession( IntPtr instancePtr, ulong steamID );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamGameServer_CancelAuthTicket" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamGameServer_SetHeartbeatInterval" )]
        internal static extern void SteamAPI_ISteamGameServer_SetHeartbeatInterval( IntPtr instancePtr, int iHeartbeatInterval );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamGameServer_ForceHeartbeat" )]
        internal static extern void SteamAPI_ISteamGameServer_ForceHeartbeat( IntPtr instancePtr );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamGameServer_AssociateWithClan" )]
        internal static extern ulong SteamAPI_ISteamGameServer_AssociateWithClan( IntPtr instancePtr, ulong steamIDClan );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_ISteamGameServer_ComputeNewPlayerCompatibility" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CUserStatsReceived_t_SetCallback" )]
        public static extern ulong CUserStatsReceived_t_SetCallback( SteamAPI_UserStatsReceived_t_Callback func );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CUserStatsReceived_t_RemoveCallback" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CRemoteStorageFileReadAsyncComplete_t_SetCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CRemoteStorageFileReadAsyncComplete_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CRemoteStorageGetPublishedItemVoteDetailsResult_t_SetCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CRemoteStorageGetPublishedItemVoteDetailsResult_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CGSStatsStored_t_SetCallResult" )]
        public static extern ulong CGSStatsStored_t_SetCallResult( ulong hAPICall, SteamAPI_GSStatsStored_t_CallResult func );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CGSStatsStored_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CHTML_BrowserReady_t_SetCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CHTML_BrowserReady_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CFriendsGetFollowerCount_t_SetCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CFriendsGetFollowerCount_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CFriendsIsFollowing_t_SetCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CFriendsIsFollowing_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CLobbyMatchList_t_SetCallResult" )]
        public static extern ulong CLobbyMatchList_t_SetCallResult( ulong hAPICall, SteamAPI_LobbyMatchList_t_CallResult func );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CLobbyMatchList_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CRemoteStorageUpdatePublishedFileResult_t_SetCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CRemoteStorageUpdatePublishedFileResult_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CStoreAuthURLResponse_t_SetCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CStoreAuthURLResponse_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CLobbyCreated_t_SetCallResult" )]
        public static extern ulong CLobbyCreated_t_SetCallResult( ulong hAPICall, SteamAPI_LobbyCreated_t_CallResult func );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CLobbyCreated_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CRemoteStorageFileWriteAsyncComplete_t_SetCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CRemoteStorageFileWriteAsyncComplete_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CRemoteStorageDeletePublishedFileResult_t_SetCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CRemoteStorageDeletePublishedFileResult_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CRemoteStorageGetPublishedFileDetailsResult_t_SetCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CRemoteStorageGetPublishedFileDetailsResult_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CRemoteStorageDownloadUGCResult_t_SetCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CRemoteStorageDownloadUGCResult_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CSteamUGCQueryCompleted_t_SetCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CSteamUGCQueryCompleted_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CRemoteStorageFileShareResult_t_SetCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CRemoteStorageFileShareResult_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CLobbyEnter_t_SetCallResult" )]
        public static extern ulong CLobbyEnter_t_SetCallResult( ulong hAPICall, SteamAPI_LobbyEnter_t_CallResult func );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CLobbyEnter_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CSubmitItemUpdateResult_t_SetCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CSubmitItemUpdateResult_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CNumberOfCurrentPlayers_t_SetCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CNumberOfCurrentPlayers_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CGSStatsReceived_t_SetCallResult" )]
        public static extern ulong CGSStatsReceived_t_SetCallResult( ulong hAPICall, SteamAPI_GSStatsReceived_t_CallResult func );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CGSStatsReceived_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CLeaderboardScoresDownloaded_t_SetCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CLeaderboardScoresDownloaded_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CRemoteStorageUpdateUserPublishedItemVoteResult_t_SetCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CRemoteStorageUpdateUserPublishedItemVoteResult_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CRemoteStorageEnumerateUserSubscribedFilesResult_t_SetCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CRemoteStorageEnumerateUserSubscribedFilesResult_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CCreateItemResult_t_SetCallResult" )]
        public static extern ulong CCreateItemResult_t_SetCallResult( ulong hAPICall, SteamAPI_CreateItemResult_t_CallResult func );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CCreateItemResult_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CSetUserItemVoteResult_t_SetCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CSetUserItemVoteResult_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CComputeNewPlayerCompatibilityResult_t_SetCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CComputeNewPlayerCompatibilityResult_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CLeaderboardScoreUploaded_t_SetCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CLeaderboardScoreUploaded_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CGlobalAchievementPercentagesReady_t_SetCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CGlobalAchievementPercentagesReady_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CGlobalStatsReceived_t_SetCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CGlobalStatsReceived_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CRemoteStorageEnumeratePublishedFilesByUserActionResult_t_SetCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CRemoteStorageEnumeratePublishedFilesByUserActionResult_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CClanOfficerListResponse_t_SetCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CClanOfficerListResponse_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CRemoteStoragePublishFileProgress_t_SetCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CRemoteStoragePublishFileProgress_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CRemoteStorageEnumerateWorkshopFilesResult_t_SetCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CRemoteStorageEnumerateWorkshopFilesResult_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CGSReputation_t_SetCallResult" )]
        public static extern ulong CGSReputation_t_SetCallResult( ulong hAPICall, SteamAPI_GSReputation_t_CallResult func );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CGSReputation_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CUserFavoriteItemsListChanged_t_SetCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CUserFavoriteItemsListChanged_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CEncryptedAppTicketResponse_t_SetCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CEncryptedAppTicketResponse_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CRemoteStorageEnumerateUserPublishedFilesResult_t_SetCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CRemoteStorageEnumerateUserPublishedFilesResult_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CFriendsEnumerateFollowingList_t_SetCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CFriendsEnumerateFollowingList_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CRemoteStorageSubscribePublishedFileResult_t_SetCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CRemoteStorageSubscribePublishedFileResult_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CGetUserItemVoteResult_t_SetCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CGetUserItemVoteResult_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CAssociateWithClanResult_t_SetCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CAssociateWithClanResult_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CLeaderboardUGCSet_t_SetCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CLeaderboardUGCSet_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CCheckFileSignature_t_SetCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CCheckFileSignature_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CRemoteStorageUnsubscribePublishedFileResult_t_SetCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CRemoteStorageUnsubscribePublishedFileResult_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CSetPersonaNameResponse_t_SetCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CSetPersonaNameResponse_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CUserStatsReceived_t_SetCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CUserStatsReceived_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CJoinClanChatRoomCompletionResult_t_SetCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CJoinClanChatRoomCompletionResult_t_RemoveCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CLeaderboardFindResult_t_SetCallResult" )]
        ...
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "CLeaderboardFindResult_t_RemoveCallResult" )]
...
namespace Valve.Steamworks
{
    ...
    {
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_RestartAppIfNecessary" )]
        internal static extern void SteamAPI_RestartAppIfNecessary( uint unOwnAppID );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_Init" )]
        internal static extern void SteamAPI_Init();
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_RunCallbacks" )]
        internal static extern void SteamAPI_RunCallbacks();
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_RegisterCallback" )]
        internal static extern void SteamAPI_RegisterCallback( IntPtr pCallback, int iCallback );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_UnregisterCallback" )]
        internal static extern void SteamAPI_UnregisterCallback( IntPtr pCallback );
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamClient" )]
        internal static extern IntPtr SteamClient();
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamUser" )]
        internal static extern IntPtr SteamUser();
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamFriends" )]
        internal static extern IntPtr SteamFriends();
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamUtils" )]
        internal static extern IntPtr SteamUtils();
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamMatchmaking" )]
        internal static extern IntPtr SteamMatchmaking();
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamMatchmakingServerListResponse" )]
        internal static extern IntPtr SteamMatchmakingServerListResponse();
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamMatchmakingPingResponse" )]
        internal static extern IntPtr SteamMatchmakingPingResponse();
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamMatchmakingPlayersResponse" )]
        internal static extern IntPtr SteamMatchmakingPlayersResponse();
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamMatchmakingRulesResponse" )]
        internal static extern IntPtr SteamMatchmakingRulesResponse();
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamMatchmakingServers" )]
        internal static extern IntPtr SteamMatchmakingServers();
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamRemoteStorage" )]
        internal static extern IntPtr SteamRemoteStorage();
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamUserStats" )]
        internal static extern IntPtr SteamUserStats();
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamApps" )]
        internal static extern IntPtr SteamApps();
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamNetworking" )]
        internal static extern IntPtr SteamNetworking();
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamScreenshots" )]
        internal static extern IntPtr SteamScreenshots();
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamMusic" )]
        internal static extern IntPtr SteamMusic();
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamMusicRemote" )]
        internal static extern IntPtr SteamMusicRemote();
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamHTTP" )]
        internal static extern IntPtr SteamHTTP();
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamUnifiedMessages" )]
        internal static extern IntPtr SteamUnifiedMessages();
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamController" )]
        internal static extern IntPtr SteamController();
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamUGC" )]
        internal static extern IntPtr SteamUGC();
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAppList" )]
        internal static extern IntPtr SteamAppList();
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamHTMLSurface" )]
        internal static extern IntPtr SteamHTMLSurface();
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamInventory" )]
        internal static extern IntPtr SteamInventory();
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamVideo" )]
        internal static extern IntPtr SteamVideo();
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamGameServer" )]
        internal static extern IntPtr SteamGameServer();
        [DllImportAttribute( Config.LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamGameServerStats" )]
