...
namespace Steamworks
{
	public class SteamTimeline : SteamClientClass<SteamTimeline>
	{
		...
		public static void SetTimelineStateDescription( string pchDescription, float flTimeDelta ) => Internal.SetTimelineStateDescription( pchDescription, flTimeDelta );

		/// <summary>
		/// Clears the previous set game state in the timeline.
		/// </summary>
		/// <param name="flTimeDelta">	The time offset in seconds to apply to this state change. Negative times indicate an event that happened in the past.</param>
		public static void ClearTimelineStateDescription( float flTimeDelta ) => Internal.ClearTimelineStateDescription( flTimeDelta );
