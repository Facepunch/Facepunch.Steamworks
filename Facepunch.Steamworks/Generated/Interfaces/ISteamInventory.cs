...
namespace Steamworks
{
	internal unsafe partial class ISteamInventory : SteamInterface
	{
		...
		internal static extern Result _GetResultStatus( IntPtr self, SteamInventoryResult_t resultHandle );
		...
		internal static extern bool _GetResultItems( IntPtr self, SteamInventoryResult_t resultHandle, [In,Out] SteamItemDetails_t[]  pOutItemsArray, ref uint punOutItemsArraySize );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _GetResultItemProperty( IntPtr self, SteamInventoryResult_t resultHandle, uint unItemIndex, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof( Utf8StringToNative ) )] string pchPropertyName, IntPtr pchValueBuffer, ref uint punValueBufferSizeOut );
		...
		internal static extern uint _GetResultTimestamp( IntPtr self, SteamInventoryResult_t resultHandle );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _CheckResultSteamID( IntPtr self, SteamInventoryResult_t resultHandle, SteamId steamIDExpected );
		...
		internal static extern void _DestroyResult( IntPtr self, SteamInventoryResult_t resultHandle );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _GetAllItems( IntPtr self, ref SteamInventoryResult_t pResultHandle );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _GetItemsByID( IntPtr self, ref SteamInventoryResult_t pResultHandle, ref InventoryItemId pInstanceIDs, uint unCountInstanceIDs );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _SerializeResult( IntPtr self, SteamInventoryResult_t resultHandle, IntPtr pOutBuffer, ref uint punOutBufferSize );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _DeserializeResult( IntPtr self, ref SteamInventoryResult_t pOutResultHandle, IntPtr pBuffer, uint unBufferSize, [MarshalAs( UnmanagedType.U1 )] bool bRESERVED_MUST_BE_FALSE );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _GenerateItems( IntPtr self, ref SteamInventoryResult_t pResultHandle, [In,Out] InventoryDefId[]  pArrayItemDefs, [In,Out] uint[]  punArrayQuantity, uint unArrayLength );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _GrantPromoItems( IntPtr self, ref SteamInventoryResult_t pResultHandle );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _AddPromoItem( IntPtr self, ref SteamInventoryResult_t pResultHandle, InventoryDefId itemDef );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _AddPromoItems( IntPtr self, ref SteamInventoryResult_t pResultHandle, [In,Out] InventoryDefId[]  pArrayItemDefs, uint unArrayLength );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _ConsumeItem( IntPtr self, ref SteamInventoryResult_t pResultHandle, InventoryItemId itemConsume, uint unQuantity );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _ExchangeItems( IntPtr self, ref SteamInventoryResult_t pResultHandle, [In,Out] InventoryDefId[]  pArrayGenerate, [In,Out] uint[]  punArrayGenerateQuantity, uint unArrayGenerateLength, [In,Out] InventoryItemId[]  pArrayDestroy, [In,Out] uint[]  punArrayDestroyQuantity, uint unArrayDestroyLength );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _TransferItemQuantity( IntPtr self, ref SteamInventoryResult_t pResultHandle, InventoryItemId itemIdSource, uint unQuantity, InventoryItemId itemIdDest );
		...
		internal static extern void _SendItemDropHeartbeat( IntPtr self );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _TriggerItemDrop( IntPtr self, ref SteamInventoryResult_t pResultHandle, InventoryDefId dropListDefinition );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _TradeItems( IntPtr self, ref SteamInventoryResult_t pResultHandle, SteamId steamIDTradePartner, [In,Out] InventoryItemId[]  pArrayGive, [In,Out] uint[]  pArrayGiveQuantity, uint nArrayGiveLength, [In,Out] InventoryItemId[]  pArrayGet, [In,Out] uint[]  pArrayGetQuantity, uint nArrayGetLength );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _LoadItemDefinitions( IntPtr self );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _GetItemDefinitionIDs( IntPtr self, [In,Out] InventoryDefId[]  pItemDefIDs, ref uint punItemDefIDsArraySize );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _GetItemDefinitionProperty( IntPtr self, InventoryDefId iDefinition, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof( Utf8StringToNative ) )] string pchPropertyName, IntPtr pchValueBuffer, ref uint punValueBufferSizeOut );
		...
		internal static extern SteamAPICall_t _RequestEligiblePromoItemDefinitionsIDs( IntPtr self, SteamId steamID );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _GetEligiblePromoItemDefinitionIDs( IntPtr self, SteamId steamID, [In,Out] InventoryDefId[]  pItemDefIDs, ref uint punItemDefIDsArraySize );
		...
		internal static extern SteamAPICall_t _StartPurchase( IntPtr self, [In,Out] InventoryDefId[]  pArrayItemDefs, [In,Out] uint[]  punArrayQuantity, uint unArrayLength );
		...
		internal static extern SteamAPICall_t _RequestPrices( IntPtr self );
		...
		internal static extern uint _GetNumItemsWithPrices( IntPtr self );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _GetItemsWithPrices( IntPtr self, [In,Out] InventoryDefId[]  pArrayItemDefs, [In,Out] ulong[]  pCurrentPrices, [In,Out] ulong[]  pBasePrices, uint unArrayLength );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _GetItemPrice( IntPtr self, InventoryDefId iDefinition, ref ulong pCurrentPrice, ref ulong pBasePrice );
		...
		internal static extern SteamInventoryUpdateHandle_t _StartUpdateProperties( IntPtr self );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _RemoveProperty( IntPtr self, SteamInventoryUpdateHandle_t handle, InventoryItemId nItemID, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof( Utf8StringToNative ) )] string pchPropertyName );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _SetProperty( IntPtr self, SteamInventoryUpdateHandle_t handle, InventoryItemId nItemID, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof( Utf8StringToNative ) )] string pchPropertyName, [MarshalAs( UnmanagedType.U1 )] bool bValue );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _SetProperty( IntPtr self, SteamInventoryUpdateHandle_t handle, InventoryItemId nItemID, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof( Utf8StringToNative ) )] string pchPropertyName, long nValue );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _SetProperty( IntPtr self, SteamInventoryUpdateHandle_t handle, InventoryItemId nItemID, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof( Utf8StringToNative ) )] string pchPropertyName, float flValue );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _SubmitUpdateProperties( IntPtr self, SteamInventoryUpdateHandle_t handle, ref SteamInventoryResult_t pResultHandle );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _InspectItem( IntPtr self, ref SteamInventoryResult_t pResultHandle, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof( Utf8StringToNative ) )] string pchItemToken );
