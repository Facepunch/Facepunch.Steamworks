...
namespace Steamworks
{
	internal unsafe partial class ISteamGameServerStats : SteamInterface
	{
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _SetUserStat( IntPtr self, SteamId steamIDUser, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof( Utf8StringToNative ) )] string pchName, int nData );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _SetUserStat( IntPtr self, SteamId steamIDUser, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof( Utf8StringToNative ) )] string pchName, float fData );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _UpdateUserAvgRateStat( IntPtr self, SteamId steamIDUser, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof( Utf8StringToNative ) )] string pchName, float flCountThisSession, double dSessionLength );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _SetUserAchievement( IntPtr self, SteamId steamIDUser, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof( Utf8StringToNative ) )] string pchName );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _ClearUserAchievement( IntPtr self, SteamId steamIDUser, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof( Utf8StringToNative ) )] string pchName );
		...
		internal static extern SteamAPICall_t _StoreUserStats( IntPtr self, SteamId steamIDUser );
