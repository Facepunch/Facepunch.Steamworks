...
namespace Steamworks
{
	internal unsafe partial class ISteamHTTP : SteamInterface
	{
		...
		internal static extern HTTPRequestHandle _CreateHTTPRequest( IntPtr self, HTTPMethod eHTTPRequestMethod, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof( Utf8StringToNative ) )] string pchAbsoluteURL );
		...
		internal static extern bool _SetHTTPRequestContextValue( IntPtr self, HTTPRequestHandle hRequest, ulong ulContextValue );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _SetHTTPRequestNetworkActivityTimeout( IntPtr self, HTTPRequestHandle hRequest, uint unTimeoutSeconds );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _SetHTTPRequestHeaderValue( IntPtr self, HTTPRequestHandle hRequest, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof( Utf8StringToNative ) )] string pchHeaderName, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof( Utf8StringToNative ) )] string pchHeaderValue );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _SendHTTPRequest( IntPtr self, HTTPRequestHandle hRequest, ref SteamAPICall_t pCallHandle );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _SendHTTPRequestAndStreamResponse( IntPtr self, HTTPRequestHandle hRequest, ref SteamAPICall_t pCallHandle );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _DeferHTTPRequest( IntPtr self, HTTPRequestHandle hRequest );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _PrioritizeHTTPRequest( IntPtr self, HTTPRequestHandle hRequest );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _GetHTTPResponseHeaderSize( IntPtr self, HTTPRequestHandle hRequest, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof( Utf8StringToNative ) )] string pchHeaderName, ref uint unResponseHeaderSize );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _GetHTTPResponseHeaderValue( IntPtr self, HTTPRequestHandle hRequest, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof( Utf8StringToNative ) )] string pchHeaderName, ref byte pHeaderValueBuffer, uint unBufferSize );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _GetHTTPResponseBodySize( IntPtr self, HTTPRequestHandle hRequest, ref uint unBodySize );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _GetHTTPResponseBodyData( IntPtr self, HTTPRequestHandle hRequest, ref byte pBodyDataBuffer, uint unBufferSize );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _GetHTTPStreamingResponseBodyData( IntPtr self, HTTPRequestHandle hRequest, uint cOffset, ref byte pBodyDataBuffer, uint unBufferSize );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _ReleaseHTTPRequest( IntPtr self, HTTPRequestHandle hRequest );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _GetHTTPDownloadProgressPct( IntPtr self, HTTPRequestHandle hRequest, ref float pflPercentOut );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _SetHTTPRequestRawPostBody( IntPtr self, HTTPRequestHandle hRequest, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof( Utf8StringToNative ) )] string pchContentType, [In,Out] byte[]  pubBody, uint unBodyLen );
		...
		internal static extern HTTPCookieContainerHandle _CreateCookieContainer( IntPtr self, [MarshalAs( UnmanagedType.U1 )] bool bAllowResponsesToModify );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _ReleaseCookieContainer( IntPtr self, HTTPCookieContainerHandle hCookieContainer );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _SetHTTPRequestCookieContainer( IntPtr self, HTTPRequestHandle hRequest, HTTPCookieContainerHandle hCookieContainer );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _SetHTTPRequestUserAgentInfo( IntPtr self, HTTPRequestHandle hRequest, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof( Utf8StringToNative ) )] string pchUserAgentInfo );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _SetHTTPRequestRequiresVerifiedCertificate( IntPtr self, HTTPRequestHandle hRequest, [MarshalAs( UnmanagedType.U1 )] bool bRequireVerifiedCertificate );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _SetHTTPRequestAbsoluteTimeoutMS( IntPtr self, HTTPRequestHandle hRequest, uint unMilliseconds );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _GetHTTPRequestWasTimedOut( IntPtr self, HTTPRequestHandle hRequest, [MarshalAs( UnmanagedType.U1 )] ref bool pbWasTimedOut );
