...
namespace Steamworks
{
	internal unsafe partial class ISteamMatchmaking : SteamInterface
	{
		...
		internal static extern int _GetFavoriteGameCount( IntPtr self );
		...
		internal static extern bool _GetFavoriteGame( IntPtr self, int iGame, ref AppId pnAppID, ref uint pnIP, ref ushort pnConnPort, ref ushort pnQueryPort, ref uint punFlags, ref uint pRTime32LastPlayedOnServer );
		...
		internal static extern int _AddFavoriteGame( IntPtr self, AppId nAppID, uint nIP, ushort nConnPort, ushort nQueryPort, uint unFlags, uint rTime32LastPlayedOnServer );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _RemoveFavoriteGame( IntPtr self, AppId nAppID, uint nIP, ushort nConnPort, ushort nQueryPort, uint unFlags );
		...
		internal static extern SteamAPICall_t _RequestLobbyList( IntPtr self );
		...
		internal static extern void _AddRequestLobbyListNumericalFilter( IntPtr self, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof( Utf8StringToNative ) )] string pchKeyToMatch, int nValueToMatch, LobbyComparison eComparisonType );
		...
		internal static extern void _AddRequestLobbyListNearValueFilter( IntPtr self, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof( Utf8StringToNative ) )] string pchKeyToMatch, int nValueToBeCloseTo );
		...
		internal static extern void _AddRequestLobbyListFilterSlotsAvailable( IntPtr self, int nSlotsAvailable );
		...
		internal static extern void _AddRequestLobbyListDistanceFilter( IntPtr self, LobbyDistanceFilter eLobbyDistanceFilter );
		...
		internal static extern void _AddRequestLobbyListResultCountFilter( IntPtr self, int cMaxResults );
		...
		internal static extern void _AddRequestLobbyListCompatibleMembersFilter( IntPtr self, SteamId steamIDLobby );
		...
		internal static extern SteamId _GetLobbyByIndex( IntPtr self, int iLobby );
		...
		internal static extern SteamAPICall_t _CreateLobby( IntPtr self, LobbyType eLobbyType, int cMaxMembers );
		...
		internal static extern SteamAPICall_t _JoinLobby( IntPtr self, SteamId steamIDLobby );
		...
		internal static extern void _LeaveLobby( IntPtr self, SteamId steamIDLobby );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _InviteUserToLobby( IntPtr self, SteamId steamIDLobby, SteamId steamIDInvitee );
		...
		internal static extern int _GetNumLobbyMembers( IntPtr self, SteamId steamIDLobby );
		...
		internal static extern SteamId _GetLobbyMemberByIndex( IntPtr self, SteamId steamIDLobby, int iMember );
		...
		internal static extern Utf8StringPointer _GetLobbyData( IntPtr self, SteamId steamIDLobby, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof( Utf8StringToNative ) )] string pchKey );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _SetLobbyData( IntPtr self, SteamId steamIDLobby, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof( Utf8StringToNative ) )] string pchKey, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof( Utf8StringToNative ) )] string pchValue );
		...
		internal static extern int _GetLobbyDataCount( IntPtr self, SteamId steamIDLobby );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _GetLobbyDataByIndex( IntPtr self, SteamId steamIDLobby, int iLobbyData, IntPtr pchKey, int cchKeyBufferSize, IntPtr pchValue, int cchValueBufferSize );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _DeleteLobbyData( IntPtr self, SteamId steamIDLobby, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof( Utf8StringToNative ) )] string pchKey );
		...
		internal static extern Utf8StringPointer _GetLobbyMemberData( IntPtr self, SteamId steamIDLobby, SteamId steamIDUser, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof( Utf8StringToNative ) )] string pchKey );
		...
		internal static extern void _SetLobbyMemberData( IntPtr self, SteamId steamIDLobby, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof( Utf8StringToNative ) )] string pchKey, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof( Utf8StringToNative ) )] string pchValue );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _SendLobbyChatMsg( IntPtr self, SteamId steamIDLobby, IntPtr pvMsgBody, int cubMsgBody );
		...
		internal static extern int _GetLobbyChatEntry( IntPtr self, SteamId steamIDLobby, int iChatID, ref SteamId pSteamIDUser, IntPtr pvData, int cubData, ref ChatEntryType peChatEntryType );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _RequestLobbyData( IntPtr self, SteamId steamIDLobby );
		...
		internal static extern void _SetLobbyGameServer( IntPtr self, SteamId steamIDLobby, uint unGameServerIP, ushort unGameServerPort, SteamId steamIDGameServer );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _GetLobbyGameServer( IntPtr self, SteamId steamIDLobby, ref uint punGameServerIP, ref ushort punGameServerPort, ref SteamId psteamIDGameServer );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _SetLobbyMemberLimit( IntPtr self, SteamId steamIDLobby, int cMaxMembers );
		...
		internal static extern int _GetLobbyMemberLimit( IntPtr self, SteamId steamIDLobby );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _SetLobbyType( IntPtr self, SteamId steamIDLobby, LobbyType eLobbyType );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _SetLobbyJoinable( IntPtr self, SteamId steamIDLobby, [MarshalAs( UnmanagedType.U1 )] bool bLobbyJoinable );
		...
		internal static extern SteamId _GetLobbyOwner( IntPtr self, SteamId steamIDLobby );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _SetLobbyOwner( IntPtr self, SteamId steamIDLobby, SteamId steamIDNewOwner );
		...
		[return: MarshalAs( UnmanagedType.I1 )]
		internal static extern bool _SetLinkedLobby( IntPtr self, SteamId steamIDLobby, SteamId steamIDLobbyDependent );
